...
Source0  : https://www.netfilter.org/pub/ipset/ipset-7.22.tar.bz2
...
%prep
%setup -q -n ipset-7.22
cd %{_builddir}/ipset-7.22
pushd ..
cp -a ipset-7.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717596691
