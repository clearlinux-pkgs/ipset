...
Source0  : https://www.netfilter.org/pub/ipset/ipset-7.20.tar.bz2
...
%prep
%setup -q -n ipset-7.20
cd %{_builddir}/ipset-7.20
pushd ..
cp -a ipset-7.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706715675
