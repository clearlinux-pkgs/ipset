...
Version  : 6.36
Release  : 16
URL      : http://ipset.netfilter.org/ipset-6.36.tar.bz2
Source0  : http://ipset.netfilter.org/ipset-6.36.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1522355061
export AR=gcc-ar
