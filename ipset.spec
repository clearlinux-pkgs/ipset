...
Version  : 7.6
Release  : 28
URL      : http://ipset.netfilter.org/ipset-7.6.tar.bz2
Source0  : http://ipset.netfilter.org/ipset-7.6.tar.bz2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582560084
...
cp %{_builddir}/ipset-7.6/COPYING %{buildroot}/usr/share/package-licenses/ipset/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/ipset-7.6/libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/ipset/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
