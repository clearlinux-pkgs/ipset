...
Version  : 6.37
Release  : 17
URL      : http://ipset.netfilter.org/ipset-6.37.tar.bz2
Source0  : http://ipset.netfilter.org/ipset-6.37.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1523392464
export AR=gcc-ar
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libipset.so.10
/usr/lib64/libipset.so.10.1.1
