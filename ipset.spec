...
Version  : 7.11
Release  : 32
URL      : https://www.netfilter.org/pub/ipset/ipset-7.11.tar.bz2
Source0  : https://www.netfilter.org/pub/ipset/ipset-7.11.tar.bz2
...
%prep
%setup -q -n ipset-7.11
cd %{_builddir}/ipset-7.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613773115
...
cp %{_builddir}/ipset-7.11/COPYING %{buildroot}/usr/share/package-licenses/ipset/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/ipset-7.11/libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/ipset/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
