...
Source0  : http://ipset.netfilter.org/ipset-7.0.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540766018
export AR=gcc-ar
...
cp COPYING %{buildroot}/usr/share/package-licenses/ipset/COPYING
cp libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/ipset/libltdl_COPYING.LIB
%make_install
...
/usr/lib64/libipset.so.13.0.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/ipset/COPYING
/usr/share/package-licenses/ipset/libltdl_COPYING.LIB
